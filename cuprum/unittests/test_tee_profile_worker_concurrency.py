"""Concurrent-worker tests for the tee profiling benchmark harness.

These tests verify that multiple worker threads launched simultaneously with
different backend selections complete without data races, errors, or incorrect
results.
"""
