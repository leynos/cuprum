...
- [ADR-013: Durable benchmark-gate telemetry][adr-013] - accepted decision to
...
- [ADR-014: Actions-runner integration harness][adr-014] - accepted decision to
...
[adr-013]: adr-013-benchmark-gate-telemetry-sink.md
[adr-014]: adr-014-actions-runner-integration-harness.md
