...
```bash
# The state machine, boundary cases, async boundary, observability, fail-fast
# event, and end-to-end wiring are split into seven focused modules sharing
# `cuprum/unittests/_pipeline_wait_support.py` scaffolding.
uv run pytest -q \
